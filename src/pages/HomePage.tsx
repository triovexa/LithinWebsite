  ...
  return (
    <div className="relative min-h-screen pt-24 pb-12 px-4 sm:px-8 max-w-7xl mx-auto flex flex-col gap-16">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-emerald-500/20 bg-slate-950/20 backdrop-blur-sm shadow-2xl min-h-[75vh] flex flex-col justify-between p-6 sm:p-12">
        ...
        {/* Real-World Commercial Transport Highway Video Background Overlay */}
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#05060f]/90 via-[#071329]/60 to-[#05060f]/80 pointer-events-none" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center pt-4">
          ...
          <div className="lg:col-span-5 relative">
            <div className="bg-white text-slate-900 p-6 sm:p-7 rounded-2xl shadow-2xl border border-slate-200 flex flex-col gap-5">
              ...
              <div className="border-b border-slate-200 pb-3">
                ...
                <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight mt-2 font-sans">
              ...
              <div className="flex flex-col gap-3">
                ...
                <a
                  href="/gallery"
                  className="w-full py-3.5 bg-[#0c1328] hover:bg-[#121c3b] text-white font-black text-xs uppercase tracking-wider rounded-xl shadow-md transition-all text-center block border border-slate-700"
                >
              ...
              <div className="flex items-center justify-between text-[11px] text-slate-500 font-medium pt-2 border-t border-slate-100">
                <a href="/services" className="hover:text-emerald-600 font-bold">Explore All Fleet Services</a>
                <a href="/about" className="hover:text-emerald-600 font-bold">Logistics Desk Contact</a>
              </div>

              {/* B2B Trust Badges */}
              <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100 text-[10px] font-extrabold uppercase text-slate-700">
