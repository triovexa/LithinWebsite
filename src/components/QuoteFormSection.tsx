  ...
  return (
    <section id="quote" className="my-16 scroll-mt-24">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        {/* Left Copy & Info */}
        <div className="lg:col-span-5 flex flex-col justify-between p-8 sm:p-10 rounded-3xl glass-panel border border-sky-300 bg-gradient-to-br from-white to-sky-100/70 shadow-lg">
          <div>
            ...
            <p className="text-slate-700 mt-4 text-sm sm:text-base leading-relaxed">
          ...
          <div className="mt-8 pt-6 border-t border-sky-200 flex items-center gap-3 text-xs text-slate-600">
        ...
        {/* Right Form Card */}
        <div className="lg:col-span-7 p-8 sm:p-10 rounded-3xl glass-panel border border-sky-300 shadow-xl bg-white">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-50 border border-sky-200 rounded-xl text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:border-[#0284c7] transition-colors"
                />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">
                  Pickup Location <span className="text-[#0284c7]">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">
                  Delivery Destination <span className="text-[#0284c7]">*</span>
                </label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-slate-50 border border-sky-200 rounded-xl text-slate-900 text-sm focus:outline-none focus:border-[#0284c7] transition-colors"
                >
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">Material / Goods Type</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">Approx. Weight (Tons)</label>
                <input
                  type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1.5">Additional Notes / Instructions</label>
              <textarea
                rows={3}
            ...
            <button
              ...
              className="w-full py-4 bg-[#0284c7] hover:bg-[#0369a1] text-white font-black rounded-xl shadow-md transition-all flex items-center justify-center gap-2 text-sm uppercase tracking-wider disabled:opacity-50"
            >
